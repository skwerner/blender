...
const CustomData_MeshMasks CD_MASK_MESH = {
    .vmask = (CD_MASK_MVERT | CD_MASK_MDEFORMVERT | CD_MASK_MVERT_SKIN | CD_MASK_PAINT_MASK |
              CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    .emask = (CD_MASK_MEDGE | CD_MASK_FREESTYLE_EDGE | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    .fmask = 0,
    .lmask = (CD_MASK_MLOOP | CD_MASK_MDISPS | CD_MASK_MLOOPUV | CD_MASK_MLOOPCOL |
              CD_MASK_CUSTOMLOOPNORMAL | CD_MASK_GRID_PAINT_MASK | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
...
const CustomData_MeshMasks CD_MASK_EDITMESH = {
    .vmask = (CD_MASK_MDEFORMVERT | CD_MASK_PAINT_MASK | CD_MASK_MVERT_SKIN | CD_MASK_SHAPEKEY |
              CD_MASK_SHAPE_KEYINDEX | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    .emask = (CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    .fmask = 0,
    .lmask = (CD_MASK_MDISPS | CD_MASK_MLOOPUV | CD_MASK_MLOOPCOL | CD_MASK_CUSTOMLOOPNORMAL |
              CD_MASK_GRID_PAINT_MASK | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    .pmask = (CD_MASK_RECAST | CD_MASK_FACEMAP | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
};
const CustomData_MeshMasks CD_MASK_DERIVEDMESH = {
    .vmask = (CD_MASK_ORIGINDEX | CD_MASK_MDEFORMVERT | CD_MASK_SHAPEKEY | CD_MASK_MVERT_SKIN |
              CD_MASK_ORCO | CD_MASK_CLOTH_ORCO | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    .emask = (CD_MASK_ORIGINDEX | CD_MASK_FREESTYLE_EDGE | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    ...
    .lmask = (CD_MASK_MLOOPUV | CD_MASK_MLOOPCOL | CD_MASK_CUSTOMLOOPNORMAL |
              ...
              CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC), /* XXX MISSING CD_MASK_MLOOPTANGENT ? */
    .pmask = (CD_MASK_ORIGINDEX | CD_MASK_RECAST | CD_MASK_FREESTYLE_FACE | CD_MASK_FACEMAP |
              CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
};
const CustomData_MeshMasks CD_MASK_BMESH = {
    .vmask = (CD_MASK_MDEFORMVERT | CD_MASK_BWEIGHT | CD_MASK_MVERT_SKIN | CD_MASK_SHAPEKEY |
              CD_MASK_SHAPE_KEYINDEX | CD_MASK_PAINT_MASK | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    .emask = (CD_MASK_BWEIGHT | CD_MASK_CREASE | CD_MASK_FREESTYLE_EDGE | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    .fmask = 0,
    .lmask = (CD_MASK_MDISPS | CD_MASK_MLOOPUV | CD_MASK_MLOOPCOL | CD_MASK_CUSTOMLOOPNORMAL |
              CD_MASK_GRID_PAINT_MASK | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    .pmask = (CD_MASK_RECAST | CD_MASK_FREESTYLE_FACE | CD_MASK_FACEMAP | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
};
/**
...
const CustomData_MeshMasks CD_MASK_EVERYTHING = {
    ...
    .emask = (CD_MASK_MEDGE | CD_MASK_BM_ELEM_PYPTR | CD_MASK_ORIGINDEX | CD_MASK_BWEIGHT |
              CD_MASK_CREASE | CD_MASK_FREESTYLE_EDGE | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
    ...
    .pmask = (CD_MASK_MPOLY | CD_MASK_BM_ELEM_PYPTR | CD_MASK_ORIGINDEX | CD_MASK_NORMAL |
              CD_MASK_RECAST | CD_MASK_FACEMAP | CD_MASK_FREESTYLE_FACE | CD_MASK_GENERIC_DATA | CD_MASK_ALEMBIC),
};
