...
bool OpenCLDeviceBase::load_kernels(const DeviceRequestedFeatures &requested_features)
{
  ...
  base_program = OpenCLProgram(
      this, "base", "kernel.cl", build_options_for_base_program(requested_features));
...
void OpenCLDeviceBase::enqueue_kernel(
...
void OpenCLDeviceBase::film_convert(DeviceTask &task,
                                    device_ptr buffer,
                                                 ...
                                                 DenoisingTask *task)
{
  ...
  kernel_set_args(ckNLMCalcDifference,
                  ...
                  a,
                  k_2);
  kernel_set_args(ckNLMBlur, 0, difference, blurDifference, w, h, stride, shift_stride, r, f);
  kernel_set_args(
      ckNLMCalcWeight, 0, blurDifference, difference, w, h, stride, shift_stride, r, f);
  ...
  kernel_set_args(ckNLMNormalize, 0, out_mem, weightAccum, w, h, stride);
                                             ...
                                             DenoisingTask *task)
{
  ...
  kernel_set_args(ckNLMCalcDifference,
                  ...
                  task->nlm_k_2);
  kernel_set_args(
      ckNLMBlur, 0, difference, blurDifference, w, h, stride, shift_stride, task->radius, 4);
  kernel_set_args(
      ckNLMCalcWeight, 0, blurDifference, difference, w, h, stride, shift_stride, task->radius, 4);
...
void OpenCLDeviceBase::denoise(RenderTile &rtile, DenoisingTask &denoising)
{
  denoising.functions.construct_transform = function_bind(
      &OpenCLDeviceBase::denoising_construct_transform, this, &denoising);
  denoising.functions.reconstruct = function_bind(
      &OpenCLDeviceBase::denoising_reconstruct, this, _1, _2, _3, &denoising);
  denoising.functions.divide_shadow = function_bind(
      &OpenCLDeviceBase::denoising_divide_shadow, this, _1, _2, _3, _4, _5, &denoising);
  denoising.functions.non_local_means = function_bind(
      &OpenCLDeviceBase::denoising_non_local_means, this, _1, _2, _3, _4, &denoising);
  denoising.functions.combine_halves = function_bind(
      &OpenCLDeviceBase::denoising_combine_halves, this, _1, _2, _3, _4, _5, _6, &denoising);
  denoising.functions.get_feature = function_bind(
      &OpenCLDeviceBase::denoising_get_feature, this, _1, _2, _3, _4, &denoising);
  denoising.functions.detect_outliers = function_bind(
      &OpenCLDeviceBase::denoising_detect_outliers, this, _1, _2, _3, _4, &denoising);
...
cl_program OpenCLDeviceBase::load_cached_kernel(ustring key, thread_scoped_lock &cache_locker)
{
  return OpenCLCache::get_program(cpPlatform, cdDevice, key, cache_locker);
}

void OpenCLDeviceBase::store_cached_kernel(cl_program program,
                                           ustring key,
                                           thread_scoped_lock &cache_locker)
{
