...
ccl_device_inline void math_vector_zero(ccl_global float *v, int n)
{
  for (int i = 0; i < n; i++) {
    v[i] = 0.0f;
  }
...
ccl_device_inline void math_matrix_zero(ccl_global float *A, int n)
{
...
ccl_device_inline void math_vector_add(ccl_global float *a, ccl_global const float *ccl_restrict b, int n)
{
  for (int i = 0; i < n; i++) {
    a[i] += b[i];
  }
...
ccl_device_inline void math_vector_mul(ccl_global float *a, ccl_global const float *ccl_restrict b, int n)
{
  for (int i = 0; i < n; i++) {
    a[i] *= b[i];
  }
...
ccl_device_inline void math_vector_mul_strided(ccl_global float *a,
                                               ccl_global const float *ccl_restrict b,
                                               int astride,
                                               int n)
{
  for (int i = 0; i < n; i++) {
...
ccl_device_inline void math_vector_scale(ccl_global float *a, float b, int n)
{
  for (int i = 0; i < n; i++) {
    a[i] *= b;
  }
...
ccl_device_inline void math_vector_max(ccl_global float *a, ccl_global const float *ccl_restrict b, int n)
{
  for (int i = 0; i < n; i++) {
    a[i] = max(a[i], b[i]);
  }
...
ccl_device_inline void math_vec3_add(ccl_global float3 *v, int n, ccl_global float *x, float3 w)
{
  for (int i = 0; i < n; i++) {
    v[i] += w * x[i];
  }
...
ccl_device_inline void math_vec3_add_strided(
    ccl_global float3 *v, int n, ccl_global float *x, float3 w, int stride)
{
  for (int i = 0; i < n; i++) {
...
ccl_device_inline void math_matrix_add_gramian(ccl_global float *A,
                                               int n,
                                               ccl_global const float *ccl_restrict v,
                                               float weight)
{
  for (int row = 0; row < n; row++) {
    for (int col = 0; col <= row; col++) {
...
ccl_device_inline void math_trimatrix_add_gramian_strided(
    ccl_global float *A, int n, ccl_global const float *ccl_restrict v, float weight, int stride)
{
  for (int row = 0; row < n; row++) {
    for (int col = 0; col <= row; col++) {
 ...
 */
ccl_device void math_matrix_jacobi_eigendecomposition(ccl_global float *A,
                                                      ccl_global float *V,
                                                      int n,
                                                      int v_stride)
{
