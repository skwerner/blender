...
ccl_device_inline void kernel_branched_path_ao(const KernelGlobals *kg,
                                               ShaderData *sd,
...
#    ifdef __VOLUME__
ccl_device_forceinline void kernel_branched_path_volume(const KernelGlobals *kg,
                                                        ShaderData *sd,
                                                        PathState *state,
                                                        Ray *ray,
                                                        float3 *throughput,
...
ccl_device_noinline_cpu void kernel_branched_path_surface_indirect_light(const KernelGlobals *kg,
                                                                         ShaderData *sd,
                                                                         ShaderData *indirect_sd,
                                                                         ShaderData *emission_sd,
                                                                         float3 throughput,
...
ccl_device void kernel_branched_path_subsurface_scatter(const KernelGlobals *kg,
                                                        ShaderData *sd,
                                                        ShaderData *indirect_sd,
                                                        ShaderData *emission_sd,
                                                        PathRadiance *L,
...
ccl_device void kernel_branched_path_integrate(const KernelGlobals *kg,
                                               uint rng_hash,
                                               int sample,
                                               Ray ray,
...
ccl_device void kernel_branched_path_trace(const KernelGlobals *kg,
                                           ccl_global float *buffer,
                                           int sample,
                                           int x,
                                           int y,
