...
ccl_device_inline float3 transform_perspective(ccl_pointer const ProjectionTransform *t, const float3 a)
{
...
ccl_device_inline float3 transform_perspective_direction(ccl_pointer const ProjectionTransform *t,
                                                         const float3 a)
{
