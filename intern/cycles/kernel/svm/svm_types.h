...
enum SvmNodeFeatureFlag {
  NODE_FEATURE_BSDF = (1 << 0),
  NODE_FEATURE_EMISSION = (1 << 1),
  NODE_FEATURE_VOLUME = (1 << 2),
  NODE_FEATURE_HAIR = (1 << 3),
  NODE_FEATURE_BUMP = (1 << 4),
  NODE_FEATURE_BUMP_STATE = (1 << 5),
  NODE_FEATURE_VORONOI_EXTRA = (1 << 6),
