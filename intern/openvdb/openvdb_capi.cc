...
bool OpenVDB_import_grid_fl_extern(OpenVDBReader *reader,
                                   const char *name,
                                   float **data,
                                   const int res_min[3],
                                   const int res_max[3],
                                   ...
                                   float *max_value)
{
  ...
  return internal::OpenVDB_import_grid_extern<openvdb::FloatGrid>(
      reader, name, data, res_min, res_max, res, level, up, front, max_value);
}
                                    ...
                                    float *max_value)
{
  ...
  return internal::OpenVDB_import_grid_vector_extern(
      reader, name, data_x, data_y, data_z, res_min, res_max, res, level, up, front, max_value);
}
