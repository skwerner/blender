...
bool PathTraceWorkGPU::adaptive_sampling_converge_and_filter(float threshold)
{
  if (adaptive_sampling_convergence_check(threshold)) {
    return true;
  }
...
bool PathTraceWorkGPU::adaptive_sampling_convergence_check(float threshold)
{
