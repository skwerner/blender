...
#define CLOSURE_IS_BSSRDF(type) \
  (type >= CLOSURE_BSSRDF_DIFFUSION_ID && type <= CLOSURE_BSSRDF_RANDOM_WALK_ID)
#define CLOSURE_IS_DIFFUSION_BSSRDF(type) (type == CLOSURE_BSSRDF_DIFFUSION_ID)
