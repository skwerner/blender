...
static void rna_MeshVertexAlembicILayer_data_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
  Mesh *me = rna_mesh(ptr);
  CustomDataLayer *layer = (CustomDataLayer *)ptr->data;
  rna_iterator_array_begin(iter, layer->data, sizeof(MAlembicIProperty), (me->edit_mesh) ? 0 : me->totvert, 0, NULL);
}
...
static void rna_MeshVertexAlembicFLayer_data_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
  Mesh *me = rna_mesh(ptr);
  CustomDataLayer *layer = (CustomDataLayer *)ptr->data;
  rna_iterator_array_begin(iter, layer->data, sizeof(MAlembicFProperty), (me->edit_mesh) ? 0 : me->totvert, 0, NULL);
}
...
static void rna_MeshVertexAlembicI3Layer_data_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
  Mesh *me = rna_mesh(ptr);
  CustomDataLayer *layer = (CustomDataLayer *)ptr->data;
  rna_iterator_array_begin(iter, layer->data, sizeof(MAlembicI3Property), (me->edit_mesh) ? 0 : me->totvert, 0, NULL);
}
...
static void rna_MeshVertexAlembicF3Layer_data_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
  Mesh *me = rna_mesh(ptr);
  CustomDataLayer *layer = (CustomDataLayer *)ptr->data;
  rna_iterator_array_begin(iter, layer->data, sizeof(MAlembicF3Property), (me->edit_mesh) ? 0 : me->totvert, 0, NULL);
}
