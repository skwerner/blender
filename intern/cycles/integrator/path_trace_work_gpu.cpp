...
bool PathTraceWorkGPU::adaptive_sampling_converge_and_filter()
{
  if (adaptive_sampling_convergence_check()) {
    return true;
  }
...
bool PathTraceWorkGPU::adaptive_sampling_convergence_check()
{
